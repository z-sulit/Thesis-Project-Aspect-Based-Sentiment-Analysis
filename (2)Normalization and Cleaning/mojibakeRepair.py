...
BASE_DIR = Path(__file__).resolve().parent.parent if Path(__file__).resolve().parent.name != "Dataset" else Path(__file__).resolve().parent                            
DATASET_DIR = BASE_DIR / "Dataset" if (BASE_DIR / "Dataset").exists() else BASE_DIR                                                                                    
